...
public class UserServiceTest {
    ...
    public void addUserTest() throws Exception {
        ...
        mockIdUser(testUser);
        Mockito.when(this.userManager.addUser(any(UserEntity.class)))
                .thenReturn(testUser);

        this.mockMvc
                .perform(post("/users/").contentType(this.contentType)
                        .content(this.jsonConverter.json(createUserDto())))
    ...
    public void addNfcToUserTest() throws Exception {
        ...
        UserEntity testUser = createUserEntity();
        mockIdUser(testUser);
        Mockito.when(this.userManager.addNfc(any(NfcTagEntity.class)))
                .thenReturn(mockNfc(testUser, createNfcEntity()));

        this.mockMvc
                .perform(post("/users/1").contentType(this.contentType)
                        .content(this.jsonConverter.json(createNfcDto())))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.userId", is(1)))
                .andExpect(jsonPath("$.name", is("clark")))
    ...
    public void replaceNfcTest() throws Exception {
        ...
        Mockito.when(this.userManager.addNfc(any(NfcTagEntity.class)))
                .thenReturn(mockNfc(testUser, nfcTagEntity));
        ...
        Mockito.doNothing().when(this.userManager)
                .updateNfc(any(NfcTagEntity.class), any(NfcTagEntity.class));
        this.mockMvc
                .perform(put("/users/1").contentType(this.contentType)
                        .content(this.jsonConverter.json(updateDto)))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.userId", is(1)))
                .andExpect(jsonPath("$.name", is("clark")))
                .andExpect(jsonPath("$.nfcTags", Matchers.hasSize(1)))
                .andExpect(jsonPath("$.nfcTags[0].disabled", is(true)));
    ...
    public void getUserByIdTest() throws Exception {
        ...
        Mockito.when(this.userManager.findById(anyLong())).thenReturn(testUser);
        this.mockMvc.perform(get("/users/1").contentType(this.contentType))
                .andExpect(status().isOk())
    ...
    public void getUserByNameTest() throws Exception {
        ...
        this.mockMvc
                .perform(
                        get("/users/?name=clark").contentType(this.contentType))
                .andExpect(status().isOk())
                .andExpect(content().contentType(this.contentType))
                .andExpect(jsonPath("$", Matchers.hasSize(1)))
                .andExpect(jsonPath("$[0].userId", is(1)))
                .andExpect(jsonPath("$[0].name", is("clark")));
    }
    @Test
    public void getLoginSessionTest() throws Exception {
        ...
        Mockito.when(this.userManager.findUser(any(UserEntity.class)))
                .thenReturn(userEntity);
        this.mockMvc
                .perform(post("/session/").contentType(this.contentType)
                        .content(this.jsonConverter.json(loginDto)))
                .andExpect(status().isOk())
                .andExpect(content().contentType(this.contentType))
                .andExpect(jsonPath("$.userId", is(1)))
                .andExpect(jsonPath("$.name", is("clark")));
